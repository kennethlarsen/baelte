...
function toHaveTextContent(htmlElement, checkWith, options = {
  ...
  return {
    ...
    message: () => {
      ...
      return (0, _utils.getMessage)((0, _jestMatcherUtils.matcherHint)(`${this.isNot ? '.not' : ''}.toHaveTextContent`, 'element', ''), `Expected element ${to} have text content`, checkWith, 'Received', textContent);
    }
  };
}